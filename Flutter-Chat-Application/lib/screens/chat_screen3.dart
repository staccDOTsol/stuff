          ...
          child: ListView(
            children: <Widget>[
              ...
              Hero(
                  tag: 'logo',
                  child: Text(
                    "Heating fuel is currently \$1.6990 / L\n\$5097 for you for a year...",
                    style: TextStyle(
                      fontSize: 35.0,
                      color: Colors.white,
                    ),
              ...
              Padding(
                ...
                child: Hero(
                  tag: "button",
                  child: TabButton(
                    btnText: "Monthly Subscription \$212.38",
              ...
              Padding(
                ...
                child: Hero(
                  tag: "button",
                  child: TabButton(
                    btnText: "Yearly Subscription \$2166.23 (15% off!)",
                    btnTxtColor: Colors.white,
                    btnColor: PalletteColors.primaryRed,
                    btnFunction: () async {
                      (_text1.text.isEmpty ||
